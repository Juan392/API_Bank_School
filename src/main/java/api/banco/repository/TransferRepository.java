...
public interface TransferRepository extends JpaRepository<Transfer, Long> {
    @Query("SELECT new api.banco.dto.transfer.TransferHistoryDTO(" +
            "t.idTransfer, t.amount, t.transferDate, origen.client.name, destino.client.name) " +
            "FROM Transfer t " +
    ...
    List<TransferHistoryDTO> searchMovesWithJoin(@Param("accountId") Long accountId);
}
